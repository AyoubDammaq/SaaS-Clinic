...
export function DoctorProfile({ doctor, onEdit, clinics }: DoctorProfileProps) {
  ...
  const clinicName = doctor.cliniqueId
    ? clinics.find(clinic => clinic.id === doctor.cliniqueId)?.name || 'Unknown Clinic'
    : 'None';
          ...
          <TabsContent value="profile" className="space-y-4">
            <div className="flex flex-col md:flex-row gap-6">
              <div className="flex flex-col items-center">
                ...
                <Button variant="outline" className="mt-4" onClick={() => onEdit(doctor)}>
                  Edit Profile
                </Button>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <Button variant="outline" className="text-red-500">Deactivate Account</Button>
                </div>
              </div>
            </div>
          </TabsContent>
