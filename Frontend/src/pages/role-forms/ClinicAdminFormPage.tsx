...
function ClinicAdminFormPage() {
  ...
  const { handleAddClinique, linkUserToClinique, handleDeleteClinique } =
    useCliniques();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!linked)
        throw new Error(
          t("failedToLinkProfile") || "Failed to link clinic profile"
        );
      ...
      const errorObj =
        err instanceof Error
          ? err
          : new Error(t("unknownError") || "Unknown error");
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">
            {t("registerClinic") || "Register Your Clinic"}
          </p>
        </div>
              ...
              <div className="grid gap-4">
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    placeholder={
                      t("clinicNamePlaceholder") || "City Medical Center"
                    }
                    required
                  />
                </div>
                ...
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    onChange={handleChange}
                    placeholder={
                      t("addressPlaceholder") || "123 Main St, City, Country"
                    }
                    required
                  />
                </div>
                ...
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    onChange={handleChange}
                    placeholder={
                      t("phoneNumberPlaceholder") || "+1 (555) 123-4567"
                    }
                    required
                  />
                </div>
                ...
                <div className="grid gap-2">
                  <Label htmlFor="website">
                    {t("websiteOptional") || "Website (optional)"}
                  </Label>
                  <Input
                    id="website"
                ...
                >
                  {isSubmitting
                    ? t("creatingClinic") || "Creating Clinic..."
