  ...
  const features = [
    {
      ...
      description: "Planifiez et gérez facilement tous vos rendez-vous médicaux avec un système de calendrier intuitif."
    },
    {
      icon: Users,
      title: "Gestion des Patients",
      description: "Centralisez toutes les informations de vos patients dans un dossier médical sécurisé et accessible."
    },
    {
      icon: Stethoscope,
      title: "Consultations Médicales",
      description: "Documentez et suivez toutes vos consultations avec des outils adaptés aux professionnels de santé."
    },
    {
      icon: UserCheck,
      title: "Gestion des Médecins",
      description: "Organisez votre équipe médicale, leurs spécialités et leurs disponibilités en toute simplicité."
    },
    {
      icon: Building2,
      title: "Multi-Cliniques",
      description: "Gérez plusieurs établissements de santé depuis une seule plateforme centralisée."
    },
    {
      icon: CreditCard,
      title: "Facturation Intégrée",
      description: "Automatisez votre facturation et suivez vos paiements avec un système comptable intégré."
    },
    {
      icon: FileText,
      title: "Dossiers Médicaux",
      description: "Accédez rapidement aux antécédents médicaux, prescriptions et résultats d'examens."
    },
    {
      icon: BarChart3,
      title: "Analyses & Rapports",
      description: "Obtenez des insights précieux sur votre activité avec des tableaux de bord personnalisés."
    },
    {
      icon: Shield,
      title: "Sécurité & Conformité",
      description: "Respectez les normes RGPD et de confidentialité médicale avec notre infrastructure sécurisée."
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/20 to-background">
        ...
        <div className="container mx-auto px-4 py-16 lg:py-24">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl lg:text-2xl text-muted-foreground mb-8 leading-relaxed">
              ...
              <span className="text-clinic-600 font-semibold">cliniques</span> et <span className="text-clinic-600 font-semibold">professionnels de santé</span>
            </p>
            <p className="text-lg text-muted-foreground mb-12 max-w-2xl mx-auto">
              Simplifiez votre quotidien médical avec une solution complète qui centralise 
              la gestion des patients, rendez-vous, consultations et bien plus encore.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              ...
              votre pratique médicale au quotidien.
            </p>
          </div>
      ...
      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold mb-6">
              Pourquoi Choisir <span className="text-clinic-600">SaaS-Clinic</span> ?
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Rejoignez des milliers de professionnels de santé qui font confiance 
              à notre plateforme pour optimiser leur pratique.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto text-white">
            ...
            <p className="text-xl mb-8 opacity-90 leading-relaxed">
              Rejoignez SaaS-Clinic dès aujourd'hui et découvrez comment notre plateforme 
              peut transformer votre gestion médicale quotidienne.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" variant="secondary" className="text-lg px-8 py-6">
                <Link to="/register">Créer Mon Compte</Link>
              </Button>
              <Button asChild size="lg" variant="outline" className="text-lg px-8 py-6 border-white text-white hover:bg-white hover:text-clinic-600">
