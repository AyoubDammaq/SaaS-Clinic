          ...
          <CardFooter className="flex flex-col space-y-4 items-center">
            <div className="text-center">
              <p className="text-sm text-muted-foreground mb-2">
                {t('noAccount')} <Link to="/register" className="text-primary font-medium">{t('registerNow')}</Link>
              </p>
              {showDemoSection && (
            ...
            {showDemoSection && (
              <div className="grid grid-cols-2 gap-2 text-xs w-full text-muted-foreground">
                <Button 
                  ...
                  onClick={() => loginWithDemo('admin@example.com', 'Super Admin')}
                >
                ...
                <Button 
                  ...
                  size="sm" 
                  className="border rounded p-2 flex flex-col items-start h-auto"
                  onClick={() => loginWithDemo('clinic@example.com', 'Clinic Admin')}
                >
                ...
                <Button 
                  ...
                  size="sm" 
                  className="border rounded p-2 flex flex-col items-start h-auto"
                  onClick={() => loginWithDemo('patient@example.com', 'Patient')}
                >
