...
namespace RDV.Application.Interfaces
{
    public interface IRendezVousService
    {
        Task<IEnumerable<RendezVousDTO>> GetAllRendezVousAsync();
        ...
        Task<IEnumerable<RendezVousStatDTO>> GetStatistiquesAsync(DateTime dateDebut, DateTime dateFin);
